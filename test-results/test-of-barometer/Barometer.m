...
for i = 377:12187
    pressure(i-376) = B.baro_pressure(i);
end

for i = 377:12187
    height(i-376) = B.z_pos(i);
end

figure(5)
plot(height,pressure,'x')
xlabel('Height [mm]') 
ylabel('Pressure [mbar]') 
title('Pressure as function of height')

figure(6)
hold on
scatter(height,pressure,'x')
fplot(@(x) -0.0001201*x+1008.66)
xlim([0 2500])
xlabel('Height [mm]') 
ylabel('Pressure [mbar]') 
title('Pressure as function of height')
text(1000,1008.74,'y = -0.0001201\cdot x + 1008.66')
text(1000,1008.72,'R^2 = 0.9392')
hold off
...
exportgraphics(gcf,'Barometer_linearreg.pdf','ContentType','vector')
